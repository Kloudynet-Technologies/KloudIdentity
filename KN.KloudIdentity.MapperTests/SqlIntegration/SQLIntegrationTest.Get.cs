...
{
    [Fact]
    public async Task GetAsync_ShouldThrowHttpRequestException_WhenIdentifierIsNull()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetAsync_ShouldThrowHttpRequestException_WhenStoredProcedureNameIsMissing()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetAsync_ShouldThrowHttpRequestException_WhenODBCConnectionIsNull()
    {
        // Arrange
        var identifier = "test-identifier";
    ...
    [Fact]
    public async Task GetAsync_ShouldThrowHttpRequestException_WhenMatchingAttributeNotFound()
    {
        // Arrange
        var identifier = "test-identifier";
