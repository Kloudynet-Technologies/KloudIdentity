...
namespace Microsoft.SCIM
{
    public static class ServiceConstants
    {
        ...
        public const string RouteGroups = SchemaConstants.PathInterface + ServiceConstants.SeparatorSegments + SchemaConstants.ApplicationIdentifier + ServiceConstants.SeparatorSegments + ProtocolConstants.PathGroups;
