...
namespace KN.KloudIdentity.Mapper.Migrations
{
    ...
    [Migration("20231122060002_add_columns_userschemamodel")]
    partial class add_columns_userschemamodel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KN.KloudIdentity.Mapper.GroupSchemaModel", b =>
                {
                    ...
                    b.Property<int?>("UserSchemaModelID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KN.KloudIdentity.Mapper.GroupSchemaModel", b =>
                {
                    ...
                    b.HasOne("KN.KloudIdentity.Mapper.UserSchemaModel", null)
                        .WithMany("ChildSchemas")
                        .HasForeignKey("UserSchemaModelID");
